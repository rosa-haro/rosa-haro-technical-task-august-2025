...
describe("UserPage — repo filters", () => {
  it("filters repositories by text on sumbit (e.g., 'rem')", async () => {
    ...
    expect(await screen.findByRole("heading", { name: /remember-me/i })).toBeInTheDocument();
    expect(screen.getByRole("heading", { name: /remix-app/i })).toBeInTheDocument();
    ...
    expect(await screen.findByRole("heading", { name: /remember-me/i })).toBeInTheDocument();
  expect(screen.getByRole("heading", { name: /remix-app/i })).toBeInTheDocument();
  expect(screen.queryByRole("heading", { name: /my-portfolio/i })).not.toBeInTheDocument();
  });
